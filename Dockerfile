...
# DATABASE_URL only needs to be a valid value at build time (no DB connection is made).
...
# Directory for the persistent SQLite file (mount a volume here in production)
